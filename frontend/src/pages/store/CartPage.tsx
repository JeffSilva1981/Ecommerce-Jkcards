          ...
          <Panel key={item.productId} className="flex gap-4 p-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                <Button variant="secondary" onClick={() => decrement(item.productId)} icon={<Minus size={16} />}>
                  Diminuir
                </Button>
                <span className="rounded-md border border-line px-3 py-2 text-sm font-semibold">
                  {item.quantity}
                </span>
                <Button variant="secondary" onClick={() => increment(item.productId)} icon={<Plus size={16} />}>
                  Aumentar
                </Button>
                <Button variant="danger" onClick={() => removeItem(item.productId)} icon={<Trash2 size={16} />}>
                  Remover
                </Button>
              </div>
            </div>
